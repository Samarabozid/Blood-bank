...
package ibdaa.bloodbank.data.model.donations;
...
public class DonationsData {
    ...
    @Expose
    private GeneralResponseData client;
    ...
    public GeneralResponseData getClient() {
        return client;
    }

    public void setClient(GeneralResponseData client) {
        this.client = client;
    }
